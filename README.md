...
URL : <http://localhost:8080/siri-lite-vue/index.html>  
Build : ng run build

### Fonctionnalitées
**siri-lite-vue** est un client permettant l’interrogation des services StopPointsDiscovery et StopMonitoring d' un serveur SIRI-LITE. 
...
![siri-lite-cli logo](siri-lite-vue.png "siri-lite-cli")
